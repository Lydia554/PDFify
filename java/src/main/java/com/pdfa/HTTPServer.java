...
public class HTTPServer {
    ...
    private static byte[] createPdfA3B(InvoiceData data) throws IOException {
        try (PDDocument document = new PDDocument()) {
            ...
            content.setNonStrokingColor(0.15f, 0.15f, 0.2f);  // Dark gray
            ...
            content.setNonStrokingColor(0.2f, 0.2f, 0.25f);  // Dark background
            ...
            content.setNonStrokingColor(0.25f, 0.25f, 0.3f);  // Dark gray
            ...
            content.setStrokingColor(0.4f, 0.4f, 0.5f);  // Dark gray line
            ...
            if (data.items != null && !data.items.isEmpty()) {
                for (LineItem item : data.items) {
                    ...
                    if (itemCount % 2 == 0) {
                        content.setNonStrokingColor(0.22f, 0.22f, 0.28f);  // Dark row tint
                    ...
                    content.setStrokingColor(0.35f, 0.35f, 0.4f);  // Dark separator
            ...
            content.setNonStrokingColor(0.15f, 0.15f, 0.2f);  // Dark gray background

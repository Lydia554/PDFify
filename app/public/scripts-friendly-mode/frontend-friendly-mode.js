...
function renderForm(template) {
  ...
  if (template === 'invoice') {
    ...
    html = `
      ...
      <label class="block text-white mb-1 font-semibold">Instructions (semicolon separated): <input id="instructions" name="instructions" rows="3" class="w-full p-1 rounded border border-gray-400 text-black"/></label>

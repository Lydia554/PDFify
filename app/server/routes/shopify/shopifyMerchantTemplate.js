...
    companyName: shopConfig.companyName || "YOUR COMPANY GMBH",
    shopName: shopConfig.shopName || "PDFify Inc.", // Use shopConfig.shopName for display
...
async function createMerchantPdf(invoiceData) {
  ...
  try {
    ...
    const copyrightText = `© 2025 ${invoiceData.shopName || invoiceData.companyName}. All rights reserved. Generated by PDFify.`;

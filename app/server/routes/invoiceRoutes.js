...
router.post("/generate-invoice", authenticate, async (req, res) => {
  ...
  try {
    ...
    // ✅ Make sure itemRows is created before cleanedData
    ...
    const html = generateInvoiceHTML(cleanedData); // make sure it uses data.itemRows
